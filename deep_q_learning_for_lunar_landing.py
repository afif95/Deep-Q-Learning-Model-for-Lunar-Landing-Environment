...
Original file is located at
    https://colab.research.google.com/drive/12Nt-pLGoH0UuwoFWOT1QOewUNHxMFOFi
...
class ReplayMemory(object):
  ...
  def push(self,event):
    ...
    if len(self.memory) > self.capacity:
      # delete first event from memory
      del self.memory[0]
...
"""### Implementing the Deep Q-Learning Network class"""
...
class Agent():
  ...
  def act(self, state, epsilon = 0.):
    # unsqueeze(0): add 1 extra batch dimension in the beginning with the existing 8 dimensions to know which batch the state belongs to
